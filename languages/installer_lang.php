...
// intro / step 1
	...
	$lang['Bugs'] = 'Please familiarize yourself with some of the documentation provided by the Pligg community at the <a href="http://forums.pligg.com/">Pligg Forums</a>. We also suggest that you register an account so that you will have access to free support, modules, widgets, templates and other great resources. If you discover any bugs, or if you just want to suggest a new feature, please post your feedback on our very own <a href="http://pligg.com/demo/">Pligg Demo website</a>.';
