...
// echo $languageContent;
	...
	if (count($result) == 0) {
		$db->query("INSERT INTO `" . table_config . "` VALUES (NULL, 'Misc', 'Auto_scroll', '1', '1', '1-3', 'Pagination Results', 'Use normal pagination links, JavaScript to automatically add more articles to the bottom of the page, or pagination with a JavaScript button to load more articles.', 'define', NULL)");
	}
