...
<fieldset><legend> {#PLIGG_Status#}</legend>
<p>{#PLIGG_Status_Instructions#}</p>

	<form action="" method="POST" id="thisform">
		<table border="0" cellspacing="8">
		<tr>
		<td width="250" colspan="2"><h2>{#PLIGG_Status_General#}: </h2></td>
		</tr>

		<tr>
		<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Switch#}">{#PLIGG_Status_Switch#}</a>:</label></td><td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Allow_Search#}">{#PLIGG_Status_Allow_Search#}</a>:</label></td>
			<td><input type="checkbox" name="status_allowsearch" id="status_allowsearch" value="1" {if $settings.allowsearch}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Email_Update#}">{#PLIGG_Status_Email_Update#}</a>:</label></td>
			<td><input type="checkbox" name="status_email" id="status_email" value="1" {if $settings.email}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Permalinks#}">{#PLIGG_Status_Permalinks#}</a></label></td>
			<td><input type="checkbox" name="status_permalinks" id="status_permalinks" value="1" {if $settings.permalinks}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Input_On_Other#}">{#PLIGG_Status_Input_On_Other#}</a></label></td>
			<td><input type="checkbox" name="status_inputonother" id="status_inputonother" value="1" {if $settings.inputonother}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Show_Permalinks#}">{#PLIGG_Status_Show_Permalinks#}</a></label></td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Results#}">{#PLIGG_Status_Results#}</a>:</label></td>
			<td><input type="text" name="status_results" id="status_results" size="3" value="{$settings.results}" style="width: 50px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Max_Char#}">{#PLIGG_Status_Max_Char#}</a>:</label></td>
			<td><input type="text" name="status_max_chars" id="status_max_chars" size="3" value="{$settings.max_chars}" style="width: 50px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Avatar_Size#}">{#PLIGG_Status_Avatar_Size#}</a>:</label></td>
			<td>
		...
		<tr>
		<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Clock_Format#}">{#PLIGG_Status_Clock_Format#}</a>:</label></td><td>
		...
		<tr><td width="250"></td><td><input type="submit" name="submit" value="{#PLIGG_Status_Submit#}" class="log2" style="font-weight:bold;padding:2px 15px 2px 15px"/></td></tr>
		
		<td width="250" colspan="2"><br /><h2>{#PLIGG_Status_Style#}: </h2></td>
		<tr>
		<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Place#}">{#PLIGG_Status_Place#}</a>:</label></td><td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Pre_Format#}">{#PLIGG_Status_Pre_Format#}</a>:</label></td>
			<td><input type="text" name="status_pre_format" id="status_pre_format" size="66" value="{$settings.pre_format}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Post_Format#}">{#PLIGG_Status_Post_Format#}</a>:</label></td>
			<td><input type="text" name="status_post_format" id="status_post_format" size="66" value="{$settings.post_format}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Pre_Comment#}">{#PLIGG_Status_Pre_Comment#}</a>:</label></td>
			<td><input type="text" name="status_pre_comment" id="status_pre_comment" size="66" value="{$settings.pre_comment}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Post_Comment#}">{#PLIGG_Status_Post_Comment#}</a>:</label></td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Pre_Story#}">{#PLIGG_Status_Pre_Story#}</a>:</label></td>
			<td><input type="text" name="status_pre_story" id="status_pre_story" size="66" value="{$settings.pre_story}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Post_Story#}">{#PLIGG_Status_Post_Story#}</a>:</label></td>
			<td><input type="text" name="status_post_story" id="status_post_story" size="66" value="{$settings.post_story}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Pre_Username#}">{#PLIGG_Status_Pre_Username#}</a>:</label></td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Post_Username#}">{#PLIGG_Status_Post_Username#}</a>:</label></td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Pre_Search#}">{#PLIGG_Status_Pre_Search#}</a>:</label></td>
			<td><input type="text" name="status_pre_search" id="status_pre_search" size="66" value="{$settings.pre_search}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Post_Search#}">{#PLIGG_Status_Post_Search#}</a>:</label></td>
			<td><input type="text" name="status_post_search" id="status_post_search" size="66" value="{$settings.post_search}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Pre_Submit#}">{#PLIGG_Status_Pre_Submit#}</a>:</label></td>
			<td><input type="text" name="status_pre_submit" id="status_pre_submit" size="66" value="{$settings.pre_submit}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Post_Submit#}">{#PLIGG_Status_Post_Submit#}</a>:</label></td>
			<td><input type="text" name="status_post_submit" id="status_post_submit" size="66" value="{$settings.post_submit}" style="width: 420px;"/></td>
		</tr>
		<tr><td width="250"></td><td><input type="submit" name="submit" value="{#PLIGG_Status_Submit#}" class="log2" style="font-weight:bold;padding:2px 15px 2px 15px"/></td></tr>

		<tr>
		<td width="250" colspan="2"><br /><h2>{#PLIGG_Status_Access#}: </h2></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Levels#}">{#PLIGG_Status_Levels#}</a>:</label></td>
			<td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Profile_Levels#}">{#PLIGG_Status_Profile_Levels#}</a>:</label></td>
			<td>
		...
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Groups#}">{#PLIGG_Status_Groups#}</a>:<br /><i>{#PLIGG_Status_Groups_Note#}</i></label></td>
			<td><input type="text" name="status_groups" id="status_groups" size="66" value="{$settings.groups}" style="width: 420px;"/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_Users#}">{#PLIGG_Status_Users#}</a>:<br /><i>{#PLIGG_Status_Users_Note#}</i></label></td>
			<td><input type="text" name="status_users" id="status_users" size="66" value="{$settings.users}" style="width: 420px;"/></td>
		</tr>
		<tr><td width="250"></td><td><input type="submit" name="submit" value="{#PLIGG_Status_Submit#}" class="log2" style="font-weight:bold;padding:2px 15px 2px 15px"/></td></tr>
		<tr>
		<td width="250" colspan="2"><br /><h2>{#PLIGG_Status_Default#}: </h2></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_User_Switch#}">{#PLIGG_Status_User_Switch#}</a>:</label></td>
			<td><input type="checkbox" name="status_user_switch" id="status_user_switch" value="1" {if $settings.user_switch}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_User_Friends#}">{#PLIGG_Status_User_Friends#}</a>:</label></td>
			<td><input type="checkbox" name="status_user_friends" id="status_user_friends" value="1" {if $settings.user_friends}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_User_Story#}">{#PLIGG_Status_User_Story#}</a>:</label></td>
			<td><input type="checkbox" name="status_user_story" id="status_user_story" value="1" {if $settings.user_story}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_User_Comment#}">{#PLIGG_Status_User_Comment#}</a>:</label></td>
			<td><input type="checkbox" name="status_user_comment" id="status_user_comment" value="1" {if $settings.user_comment}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_User_Group#}">{#PLIGG_Status_User_Group#}</a>:</label></td>
			<td><input type="checkbox" name="status_user_group" id="status_user_group" value="1" {if $settings.user_group}checked{/if}/></td>
		</tr>
		<tr>
			<td width="250" style="text-align:right"><label><a href="#{#PLIGG_Status_User_Email#}">{#PLIGG_Status_User_Email#}</a>:</label></td>
			<td><input type="checkbox" name="status_user_email" id="status_user_email" value="1" {if $settings.user_email}checked{/if}/></td>
		</tr>

		<tr><td width="250"></td><td><input type="submit" name="submit" value="{#PLIGG_Status_Submit#}" class="log2" style="font-weight:bold;padding:2px 15px 2px 15px"/><br /><br /></td></tr>
