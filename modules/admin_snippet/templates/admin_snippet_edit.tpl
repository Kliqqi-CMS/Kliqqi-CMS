...
{/if}
	...
	<form action="" method="POST" id="thisform">
		<table>
			<tbody>
				<tr>
					...
					<td><input type="text" name="snippet_name" id="snippet_name" value="{$snippet.snippet_name}" class="span12" /></td>
				</tr>
				<tr>
					<td><label><strong>{#PLIGG_Admin_Snippet_Location#}: &nbsp;</strong></label></td>
					<td>
						<select name="snippet_location" class="span12">
				...
				{if $snippet.snippet_updated}
					<tr>
						...
						<td><input type="text" id="snippet_updated" value="{$snippet.snippet_updated}" class="span12" disabled readonly/></td>
					</tr>
				{/if}
			</tbody>
		</table>
		...
		<textarea id="textarea-1" name="snippet_content" rows="15" class="span12">{$snippet.snippet_content|escape}</textarea>
		<br />
