<?php
	...
	$module_info['homepage_url'] = 'http://pligg.com/downloads/module/facebook-connect-module/';
	$module_info['update_url'] = 'http://pligg.com/downloads/module/facebook-connect-module/version/';
