...
class OAuthUtil {
   ...
   */
  public function encodeUrlEncodedArray($params){
  ...
  */
  public function decodeUrlEncodedArray($urlParams){
	  $paramsArr = array();
	  $params = array();
	  $name = '';
	  $value = '';
  ...
  public function decodeHeaderEncodedArray($headerValue){
	  $valuesArr = array();
	  $pairs = array();
	  $name = '';
	  $value = '';
  ...
  */
  public function normalizeHTTPMethod($method) {
