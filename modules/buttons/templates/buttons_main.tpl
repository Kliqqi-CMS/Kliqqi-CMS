...
{/if}
	...
	<textarea rows="3" class="span12" name="largebutton" id="largebutton" onClick="SelectAll('largebutton');">
		&lt;script src="{$my_base_url}{$my_pligg_base}/modules/buttons/buttons.js" type="text/javascript">&lt;/script>
		&lt;a class="PliggButton PliggLarge" href="http://SAMPLE-LINK.com" title="Example Title" rev="Category 1, Fallback Category 2" rel="Tag1, Tag2, Tag3">
			&lt;span style="display:none">Article Content Here!&lt;/span>
		&lt;/a>
	</textarea>
	...
	<textarea rows="3" class="span12" name="smallbutton" id="smallbutton" onClick="SelectAll('smallbutton');">
		&lt;script src="{$my_base_url}{$my_pligg_base}/modules/buttons/buttons.js" type="text/javascript">&lt;/script>
		&lt;a class="PliggButton PliggSmall" href="http://SAMPLE-LINK.com" title="Example Title" rev="Category 1, Fallback Category 2" rel="Tag1, Tag2, Tag3">
			&lt;span style="display:none">Article Content Here!&lt;/span>
		&lt;/a>
	</textarea>
	...
	<textarea rows="6" class="span12" name="wordpress" id="wordpress" onClick="SelectAll('wordpress');">
		&lt;div style="float:left;margin:1px 10px 0px 1px;">
			&lt;script src="{$my_base_url}{$my_pligg_base}/modules/buttons/buttons.js" type="text/javascript">&lt;/script>
			&lt;a class="PliggButton PliggLarge" href="&lt;?php the_permalink(); ?>" title="&lt;?php the_title(); ?>" rev="&lt;?php the_category(', '); ?>" rel="&lt;?php $posttags = wp_get_post_terms( get_the_ID() , 'post_tag' , 'fields=names' );if( $posttags ) echo implode( ', ' , $posttags ); ?>">
				&lt;span style="display:none">&lt;?php $excerpt = strip_tags(get_the_excerpt());echo $excerpt; ?>&lt;/span>
			&lt;/a>
		&lt;/div>
	</textarea>
	...
	<textarea rows="5" class="span12" name="blogspot" id="blogspot" onClick="SelectAll('blogspot');">
		&lt;div style="float:left;margin:1px 10px 0px 1px;">
