...
<form action="" method="POST" id="thisform">
	...
	<textarea name='spam_light' class="span12" rows="15">{$settings.spam_light}</textarea>
	...
	<textarea name='spam_medium' class="span12" rows="15">{$settings.spam_medium}</textarea>
	<br /><input type="submit" name="submit" value="{#PLIGG_Spam_Trigger_Submit#}" class="btn btn-primary" />
	<br /><br />
	
	<legend>{#PLIGG_Spam_Trigger_Hard_List#}: </legend>
	<p>{#PLIGG_Spam_Trigger_Hard_Description#}</p>
	<textarea name='spam_hard' class="span12" rows="15">{$settings.spam_hard}</textarea>
	<br /><input type="submit" name="submit" value="{#PLIGG_Spam_Trigger_Submit#}" class="btn btn-primary" />
	<br />
