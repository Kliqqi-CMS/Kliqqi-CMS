<ul>
	{checkActionsTpl location="tpl_pligg_panel_tools_start"}
	<li><a href="{$my_pligg_base}/admin/admin_delete_cache.php" data-toggle="modal">{#PLIGG_Visual_AdminPanel_Delete_Cache#}</a></li>
