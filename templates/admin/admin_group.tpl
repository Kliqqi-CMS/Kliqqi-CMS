			...
			<tr>
				<td>
					{if $group.group_status!='Enable'}
						<a href='?mode=approve&group_id={$group.group_id}'><img src="{$my_base_url}{$my_pligg_base}/templates/admin/images/icon_bury.gif" title="{#PLIGG_Visual_AdminPanel_Group_Approve#}" alt="{#PLIGG_Visual_AdminPanel_Group_Approve#}" /></a>
					{else}
						<img src="{$my_base_url}{$my_pligg_base}/templates/admin/images/icon_share_true.gif" title="{#PLIGG_Visual_AdminPanel_Group_Approve#}d" alt="{#PLIGG_Visual_AdminPanel_Group_Approve#}d" />
					{/if}
				...
				<td style="text-align:center;"><a href='../editgroup.php?id={$group.group_id}' rel="width:800,height:700"><img src="{$my_base_url}{$my_pligg_base}/templates/admin/images/user_edit.gif" alt="{#PLIGG_Visual_AdminPanel_Group_Edit#}" title="{#PLIGG_Visual_AdminPanel_Group_Edit#}" /></a></td>
				<td style="text-align:center;"><a onclick='return confirm("{#PLIGG_Visual_Group_Delete_Confirm#}");' href='?mode=delete&group_id={$group.group_id}'><img src="{$my_base_url}{$my_pligg_base}/templates/admin/images/delete.png" alt="{#PLIGG_Visual_AdminPanel_Group_Delete#}" title="{#PLIGG_Visual_AdminPanel_Group_Delete#}" /></a></td>
			</tr>
		{/foreach}
		</tbody>
	</table>
