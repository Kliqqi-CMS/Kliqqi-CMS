	...
	<tbody>
		{foreach from=$groups item=group}
			<tr {if $group.group_status!='Enable'}class="tr_moderated"{/if}>
				...
				<td style="text-align:center;"><a class="btn btn-danger" onclick='return confirm("{#PLIGG_Visual_Group_Delete_Confirm#}");' href='?mode=delete&group_id={$group.group_id}'><i class="fa fa-trash" alt="{#PLIGG_Visual_AdminPanel_Group_Delete#}" title="{#PLIGG_Visual_AdminPanel_Group_Delete#}"></i></a></td>
