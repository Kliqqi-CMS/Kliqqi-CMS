...
<div style="margin:8px 10px;">
	...
	<p><a class="btn" href="{$admin_new_url}">Set as New</a> &ndash; {#PLIGG_Visual_Change_Link_Queued#}</p>
	...
	<p><strong>{#PLIGG_Visual_Change_Link_URL#}:</strong> <a href="{$link_url}" target="_blank">{$link_url}</a> &ndash; <a class="btn btn-danger btn-mini" href="{$my_base_url}{$my_pligg_base}/admin/domain_management.php?id={$link_id}&add={$banned_domain_url}">{#PLIGG_Visual_Ban_This_URL#}</a></p>
