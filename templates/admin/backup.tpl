...
{if $isAdmin eq 1}
	...
	if($canIhaveAccess == 1) {
		...
		if ($backup_permissions !== '0777'){
			...
			//echo '<h3>';{/php}{#PLIGG_Visual_View_Backup#}{php}echo':</h3>';
			echo '<table class="table table-striped table-condensed"><thead><tr>';
			echo '<th><a class="btn" style="margin-bottom:6px;" href="?dobackup=files">';{/php}{#PLIGG_Visual_View_Backup_Files#}{php} echo'</a>';
