...
{checkActionsTpl location="tpl_widget_login_start"}
	<form action="{$URL_login}" method="post"> 
		{#PLIGG_Visual_Login_Username#}:<br /><input autofocus="autofocus" type="text" name="username" class="login" value="{if isset($login_username)}{$login_username}{/if}" tabindex="40" /><br />
		...
		<input type="submit" value="{#PLIGG_Visual_Login_LoginButton#}" class="btn" tabindex="43" />
	</form>
