    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          {* Next few lines form the button that appears in the navbar when the page width is small *}
          ...
          <a class="brand" href="{$my_base_url}{$my_pligg_base}">{#PLIGG_Visual_Name#}</a></a>
					...
					<div class="modal-body">
						...
						<form action="{$URL_register}" method="post" id="thisform" class="form-horizontal">
							<div class="control-group">
								...
								<div class="controls">
									{if isset($form_password_error)}{ foreach value=error from=$form_password_error }<div class="alert alert-block alert-error fade in"><button data-dismiss="alert" class="close">×</button>{$error}</div>{ /foreach }{/if}
