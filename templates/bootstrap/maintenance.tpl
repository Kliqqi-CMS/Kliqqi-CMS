	...
	<body dir="{#PLIGG_Visual_Language_Direction#}" {$body_args}>
		<div class="container" style="margin-top:30px;">
			<div class="hero-unit">
				...
				<p>
					<a href="javascript: history.go(-1)" class="btn btn-large">&laquo; Go Back</a> or 
					<a href="javascript:location.reload(true)" class="btn btn-primary btn-large">Refresh Page</a>
				</p>
			</div>
			<hr>
			<footer>
