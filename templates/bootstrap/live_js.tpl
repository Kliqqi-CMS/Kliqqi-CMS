...
function to_html(data) {ldelim}
	...
	if (data.type == 'problem')
		...
		html += '<td class="live2-type"><strong><a href="<?php echo my_pligg_base; ?>/live_unpublished.php">'+data.type+'</a></strong></td>';
	else if (data.type == 'published')
		html += '<td class="live2-type"><strong><a href="<?php echo my_pligg_base; ?>/live_published.php">'+data.type+'</a></strong></td>';	
	else if (data.type == 'comment')
		html += '<td class="live2-type"><strong><a href="<?php echo my_pligg_base; ?>/live_comments.php">'+data.type+'</a></strong></td>';	
	else
		html += '<td class="live2-type">'+data.type+'</td>';

	html += '<td class="live2-votes">'+data.votes+'</td>';
	html += '<td class="live2-story"><a href="<?php echo my_base_url.my_pligg_base; ?>/story.php?id='+data.link+'">'+data.title+'</a></td>';
	if (data.type == 'problem')
		html += '<td class="live2-who"><span class="live2-problem">'+data.who+'</span></td>';
	else if (data.uid > 0) 
		html += '<td class="live2-who"><a href="<?php echo my_base_url.my_pligg_base; ?>/user.php?login='+data.who+'">'+data.who+'</a></td>';
	else 
		html += '<td class="live2-who">'+data.who+'</td>';
