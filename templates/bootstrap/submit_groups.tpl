	...
	<fieldset>
		...
		<form action="{$URL_submit_groups}" method="post" name="thisform" id="thisform" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="group_title" class="span7" name="group_title" value="{$templatelite.post.group_title}" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="group_description" rows="10" class="span7" id="group_description" >{$templatelite.post.group_description}</textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="group_mailer" class="span7" name="group_mailer" value="{$templatelite.post.group_mailer}">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="group_vote_to_publish" class="input-mini" name="group_vote_to_publish" value="{$templatelite.post.group_vote_to_publish}">
