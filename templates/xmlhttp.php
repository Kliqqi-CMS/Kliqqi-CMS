...
//		new Effect.Fade(target3);
		if (value > 0) { target2.innerHTML = "<span class='btn'>" + PLIGG_Visual_Vote_Cast + "</span> "; }
		else if (value < 0 ) { target2.innerHTML = "<span class='btn btn-danger'>" + PLIGG_Visual_Vote_Report + "</span> ";
